...
@Component
@Slf4j
public class ScoreboardCommand implements SlashCommand {
  ...
  public Mono<Void> handle(ChatInputInteractionEvent event) {
    ...
    log.info("{} triggered the scoreboard command", username);
    return event.reply().withEphemeral(true).withContent(yahooService.getScoreUpdates(false));
  }
}
